...
let listArr = [
    ['../story/abogacia/abogacia.html', 'Abogacía'],
    ['../story/sicariato/sicariato.html', 'Sicariato'],
    ['../story/mecanica/mecanica.html', 'Mecánica'],
]
storyStrut('El misterioso Hombre de la Bolsa', '../../img/Boogey.JPG', undefined, par, listArr, '../news/news.html', undefined);